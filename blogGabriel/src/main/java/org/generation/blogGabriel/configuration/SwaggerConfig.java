package org.generation.blogGabriel.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket (DocumentationType.SWAGGER_2)
				...
				.basePackage("org.generation.blogGabriel.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
				...
				.licenseUrl("https://github.com/Gabrielgjs")
				.contact(contact())
				.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("Gabriel Jesus", "https://github.com/Gabrielgjs", "gjsgabriel83@gmail.com");
	}
